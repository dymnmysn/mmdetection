...
class CocoPanopticDataset(CocoDataset):
    ...
    METAINFO = {
        'classes':
        ('UNDEFINED', 'EGO_VEHICLE', 'CAR', 'TRUCK', 'BUS', 'OTHER_LARGE_VEHICLE', 'BICYCLE', 'MOTORCYCLE', 'TRAILER', 'PEDESTRIAN', 'CYCLIST', 'MOTORCYCLIST', 'BIRD', 'GROUND_ANIMAL', 'CONSTRUCTION_CONE_POLE', 'POLE', 'PEDESTRIAN_OBJECT', 'SIGN', 'TRAFFIC_LIGHT', 'BUILDING', 'ROAD', 'LANE_MARKER', 'ROAD_MARKER', 'SIDEWALK', 'VEGETATION', 'SKY', 'GROUND', 'DYNAMIC', 'STATIC'),
        'thing_classes':
